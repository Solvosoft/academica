    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('renewal_period', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='membership_core.RenewalPeriod')),
                ('services', models.ManyToManyField(to='membership_core.Service')),
            ],
        ),
    ]
