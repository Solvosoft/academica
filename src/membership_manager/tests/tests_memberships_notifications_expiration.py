...
from membership_manager.task_utils import invoice_creation, notify_invoice_expiration
from membership_manager.tests.utils import create_contacts, add_organization, \
    generate_memberships_to_notify_expiration_create_invoice, generate_memberships_to_notify_expiration
...
class MembershipExpirationNotify(TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        super(MembershipExpirationNotify, cls).setUpClass()
        loademailtemplates()
